...
def generate_package_list():
  global args, os_name, os_version, rdistro, default_os_installer, dist_data, rindex, rcache, rview
...
def get_package_dist_info(pkg_name):
  global os_name, os_version, rdistro, default_os_installer, dist_data, rindex, rcache, rview
